...
char Generic_Rubix_Cube_Solver::getColorLetter(COLOR color) {
    switch (color) {
        case COLOR::BLUE:
            return 'B';
        case COLOR::GREEN:
...
string Generic_Rubix_Cube_Solver::getMove(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return "L";
        case MOVE::R:
...
Generic_Rubix_Cube_Solver &Generic_Rubix_Cube_Solver::move(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return this->l();
        case MOVE::LPRIME:
...
Generic_Rubix_Cube_Solver &Generic_Rubix_Cube_Solver::invert(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return  this->lPrime();
        case MOVE::LPRIME:
...
void Generic_Rubix_Cube_Solver::print()  {
    cout << "Rubik's Cube:\n\n";
...
vector<Generic_Rubix_Cube_Solver::MOVE> Generic_Rubix_Cube_Solver::randomShuffleCube(unsigned int times) {
